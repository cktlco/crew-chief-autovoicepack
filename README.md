https://github.com/cktlco/crew-chief-autovoicepack/releases/download/v3.0/crew-chief-autovoicepack-Leon_de.zip) <br>  [Luis - 1.6GB](https://github.com/cktlco/crew-chief-autovoicepack/releases/download/v3.0/crew-chief-autovoicepack-Luis_de.zip) |  |
...
## 🚧️ Known Issues
- occasional **poor or incorrect Text-to-Speech pronunciations** (driver names, corner names, etc.)
- occasional **garbled or corrupt audio**
...
**Windows/Mac**: https://docs.docker.com/desktop/install/windows-install/
...
```
**This is a large file (15GB)** and will take time to download.

You can **confirm this step worked** with `docker image list ghcr.io/cktlco/crew-chief-autovoicepack`.
...
5) Optional Spotter voice: Copy contents of the `...\sounds\alt\Luis\voice\spotter\` folder to a new folder named `...\sounds\voice\spotter_Luis\`
...
- Use an audio player that will let you listen to an entire folder tree (such as [resonic](https://resonic.at/))
...
A 24GB GPU (RTX 4090/3090) will enable [running 8 replicas in parallel](#-common-task-running-multiple-containers-in-parallel-to-speed-up-voice-pack-generation), each many times faster than the CPU version. 16GB GPUs (RTX 4080/4070/4060Ti) or lower will support proportionally fewer replicas before being constrained by GPU VRAM. Even with an 8GB GPU and a single container running the audio generation script, **using a GPU will be much faster than the CPU-only mode**.
...
The .wav files generated by `crew-chief-autovoicepack` are (perhaps unnecessarily) larger since they are stored with 32-bit resolution at 24KHz. There are also **many more .wav files in your new voice pack** due to the `--variation_count` parameter, which defaults to 2, but can be set to 0 to disable variations and save storage space, or higher to generate more varied audio at the cost of storage.


## 💼 Common Question: How large is the Docker image? Can I free up that disk space once the voice pack is complete?

The Docker image itself is large at ~15GB, specifically including large data and developer dependencies in the image, such as a pre-trained text-to-speech model alongside related machine learning frameworks. 

Once you are satisfied with your generated voice pack, you can remove the downloaded Docker image from your local machine with `docker image rm ghcr.io/cktlco/crew-chief-autovoicepack:latest`.

As a reminder, the Docker image is only used when creating the folder of .wav files ("voice pack") and is not needed for CrewChief operation or to play back the audio files once they are generated. Anyone you share the voice pack with will not need the Docker image to use it.
...
Important: You cannot create an entirely new custom phrase (like "That last incident is under investigation") unless it corresponds to an "intention" (folder name in the phrase inventory) that CrewChief already recognizes, but you can add an unlimited number and variety of new phrases to any of the existing folders.
...
- In general, use the same value for `text_for_tts` and `subtitle` unless you're trying to perfect a pronunciation issue
...
Other tips:
- Use a modern audio file editor ([ocenaudio](https://www.ocenaudio.com/), [resonic](https://resonic.at/), Audacity, etc.) to **view the waveform** for each audio clip.
...
- **Recommended**: Perform this step **automatically** with the provided `translate_phrases.py` script, using a locally-accessible [Ollama](https://ollama.com) language model such as Mistral, Qwen, or LLama 3.1. Read the script for usage information.
...
The coqui xtts **model is multilingual and should work well with many languages**, but the quality of the translations will depend on the quality of the machine translation and the quality of the original audio recordings. You may need to experiment with different translation techniques to get the best results, but crew-chief-autovoicepack will still do most of the work -- **imagine having to record and edit 10,000 audio clips** yourself (you'd need the patience of a Belowski).
...
- `translate_phrases.py`: **automatically translates** `phrase_inventory.csv` into a different language using a self-hosted language model
...
- [[DONE](#-common-question-how-do-i-create-a-voice-pack-in-a-different-language)] Automate **multilingual machine translation**
...
- **coqui tts** -- general-purpose TTS framework: https://github.com/coqui-ai/TTS/tree/main
- **coqui xtts model** -- multilingual TTS model created by coqui: https://coqui-tts.readthedocs.io/en/latest/models/xtts.html
